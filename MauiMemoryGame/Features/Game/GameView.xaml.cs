...
public partial class GameView
{
    ...
    protected override void CreateBindings(CompositeDisposable disposables)
    {
        ...
        this.OneWayBind(ViewModel, vm => vm.CardPairsFound, v => v.lbPairs.Text).DisposeWith(disposables);
    ...
    private object GetTimePercentage(TimeSpan remainingTime)
    {
    ...
    private async void TapGestureRecognizer_Tapped(object sender, object value)
    {
        if (isManagingCards)
            return;
